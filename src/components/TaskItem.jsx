...
function TaskItem({ taskName, checked, id }) {
  ...
  return (
    <label className="select-none">
      <span className="flex items-center min-h-20 gap-5 p-5 px-10 hover:bg-gray-100 group">
        ...
        <span className="flex-1 text-xl peer-has-checked:line-through truncate max-w-[calc(100%-100px)]">
          {edit ? (
